...
const ::uint32_t TableStruct_Heartbeat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::Orika::heartbeat, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::Orika::heartbeat, _impl_.type_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::Orika::heartbeat)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::Orika::_heartbeat_default_instance_._instance,
};
const char descriptor_table_protodef_Heartbeat_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\017Heartbeat.proto\022\005Orika\"\031\n\theartbeat\022\014\n"
...
heartbeat::heartbeat(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:Orika.heartbeat)
}
heartbeat::heartbeat(const heartbeat& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Orika.heartbeat)
}
...
heartbeat::~heartbeat() {
  // @@protoc_insertion_point(destructor:Orika.heartbeat)
...
// @@protoc_insertion_point(message_clear_start:Orika.heartbeat)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Orika.heartbeat.type"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* heartbeat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Orika.heartbeat)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_type().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "Orika.heartbeat.type");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Orika.heartbeat)
  return target;
}

::size_t heartbeat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Orika.heartbeat)
  ::size_t total_size = 0;
...
void heartbeat::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Orika.heartbeat)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Orika.heartbeat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::Orika::heartbeat*
Arena::CreateMaybeMessage< ::Orika::heartbeat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Orika::heartbeat >(arena);
}
