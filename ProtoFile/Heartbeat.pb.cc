...
const ::uint32_t TableStruct_Heartbeat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::Oreka::HeartBeat, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::Oreka::HeartBeat, _impl_.type_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::Oreka::HeartBeat)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::Oreka::_HeartBeat_default_instance_._instance,
};
const char descriptor_table_protodef_Heartbeat_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\017Heartbeat.proto\022\005Oreka\"\031\n\tHeartBeat\022\014\n"
...
HeartBeat::HeartBeat(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:Oreka.HeartBeat)
}
HeartBeat::HeartBeat(const HeartBeat& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Oreka.HeartBeat)
}
...
HeartBeat::~HeartBeat() {
  // @@protoc_insertion_point(destructor:Oreka.HeartBeat)
...
// @@protoc_insertion_point(message_clear_start:Oreka.HeartBeat)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Oreka.HeartBeat.type"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* HeartBeat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Oreka.HeartBeat)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_type().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "Oreka.HeartBeat.type");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Oreka.HeartBeat)
  return target;
}

::size_t HeartBeat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Oreka.HeartBeat)
  ::size_t total_size = 0;
...
void HeartBeat::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Oreka.HeartBeat)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Oreka.HeartBeat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::Oreka::HeartBeat*
Arena::CreateMaybeMessage< ::Oreka::HeartBeat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Oreka::HeartBeat >(arena);
}
